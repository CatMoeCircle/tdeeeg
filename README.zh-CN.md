...
> ⚠️ **本项目功能尚未完善，处于积极开发阶段。** 多数核心功能已实现但可能存在不稳定或显示不符合预期的部分，欢迎试用并提交 Issue。
...
当前维护者暂无 macOS 设备，因此无法对 macOS 版本进行测试与打包。框架 Tauri 理论上兼容 macOS，但尚未实际验证。欢迎拥有 macOS 环境的开发者尝试构建，并协助完善相关支持。
...
本项目基于 [GNU General Public License v3.0](LICENSE) 发布，完整条款见 [LICENSE](LICENSE) 文件。
