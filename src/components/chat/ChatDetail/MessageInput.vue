<template>
    <div class="p-5 bg-transparent">
        <div
            class="flex items-center gap-3 bg-white/60 dark:bg-gray-900/80 backdrop-blur-md px-2 rounded-4xl shadow-lg border border-gray-200/50 dark:border-gray-700/50">
            <!-- 文件选择（左侧） -->
            <div class="shrink-0">
